...
<body>
    <div id="overlay" class="overlay">
        ...
        <div class="text">
            <h4>Classement</h4>
            <p>Top Classement juste a SERVIGES neutre 1 (1)</p>
        </div>
    </div>
    <div id="overlay1" class="overlay">
        ...
        <div class="text">
            <h4>Classement</h4>
            <p>Top Classement juste a SERVIGES neutre 2 (2)</p>
        </div>
    </div>
    <div id="overlay2" class="overlay">
        ...
        <div class="text">
            <h4>Classement</h4>
            <p>Top Classement juste a SERVIGES neutre 3 (3)</p>
        </div>
    </div>
    <div id="overlay3" class="overlay">
        ...
        <div class="text">
            ...
            <p>Top Classement juste a SERVIGES neutre 4 (4)</p>
    ...
    <div id="overlay4" class="overlay">
        ...
        <div class="text">
            <h4>Classement</h4>
            <p>Top Classement juste a SERVIGES neutre 5 (5)</p>
        </div>
    </div>
    <div id="overlay5" class="overlay">
        ...
        <div class="text">
            <h4>Classement</h4>
            <p>Top Classement juste a SERVIGES neutre 6 (6)</p>
        </div>
    </div>
    <div id="Acceuil">
        <section id="main">
    ...
    <div class="collections">
        <div id="1" class="pic" onclick="on()">
            <img src="images/Clas1.jpeg" />
        </div>
        <div id="2" class="pic" onclick="on1()">
            <img src="images/Clas2.jpeg" />
        </div>
        <div id="3" class="pic" onclick="on2()">
            <img src="images/Clas3.jpeg" />
        </div>
        <div id="4" class="pic" onclick="on3()">
            <img src="images/Clas4.jpeg" />
        </div>
        <div id="5" class="pic" onclick="on4()">
            <img src="images/Clas5.jpeg" />
        </div>
        <div id="6" class="pic" onclick="on5()">
            <img src="images/Clas6.jpeg" />
        </div>
    </div>
    <style>
