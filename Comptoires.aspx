...
<body>
    <div id="overlay" class="overlay">
        ...
        <div class="text">
            <h4>Comptoire 1</h4>
            <p>Comptoir magnifique de bonne qualite </p>
        </div>
    </div>
    <div id="overlay1" class="overlay">
        ...
        <div class="text">
            <h4>Comptoire 2</h4>
            <p>un bon design de comptoire </p>
        </div>
    </div>
    <div id="overlay2" class="overlay">
        ...
        <div class="text">
            <h4>Comptoire 3</h4>
            <p>Comptoire rare juste sur SERVIGES </p>
        </div>
    </div>
    <div id="overlay3" class="overlay">
        ...
        <div class="text">
            ...
            <p>Meilleur comptoire pour votre entreprise</p>
    ...
    <div id="overlay5" class="overlay">
        ...
        <div class="text">
            <h4>Comptoire 6</h4>
            <p>SERVIGES vous offre des Top comptoires pour votre entreprise</p>
        </div>
    </div>
    <div id="Acceuil">
        <section id="main">
