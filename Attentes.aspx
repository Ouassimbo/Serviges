...
<body>
    <div id="overlay" class="overlay">
        ...
        <div class="text">
            <h4>Attentes 1</h4>
            <p>Attentes bonne qualite iD=1</p>
        </div>
    </div>
    <div id="overlay1" class="overlay">
        ...
        <div class="text">
            <h4>Attentes 2</h4>
            <p>Attentes bonne qualite iD=2</p>
        </div>
    </div>
    <div id="overlay2" class="overlay">
        ...
        <div class="text">
            <h4>Attentes 3</h4>
            <p>Attentes bonne qualite iD=3</p>
        </div>
    </div>
    <div id="overlay3" class="overlay">
        ...
        <div class="text">
            ...
            <p>Attentes bonne qualite iD=4</p>
    ...
    <div id="overlay4" class="overlay">
        ...
        <div class="text">
            <h4>Attentes 5</h4>
            <p>Attentes bonne qualite iD=5</p>
        </div>
    </div>
    <div id="overlay5" class="overlay">
        ...
        <div class="text">
            <h4>Attentes 6</h4>
            <p>Attentes bonne qualite iD=6</p>
        </div>
    </div>
    <div id="Acceuil">
        <section id="main">
