...
<body>
    <div id="overlay" class="overlay">
        ...
        <div class="text">
            <h4>Mobilier sur mesure 1 </h4>
            <p>Nouvelle collection de mobilier</p>
        </div>
    </div>
    <div id="overlay1" class="overlay">
        <a href="javascript:void(0)" class="closebtn" onclick="off()">&times;</a>
        <div class="text">
            <h4>Mobilier sur mesure 2 </h4>
            <p>La gamme de mobilier sur mesure du bonne qualite </p>
        </div>
    </div>
    <div id="overlay2" class="overlay">
        <a href="javascript:void(0)" class="closebtn" onclick="off()">&times;</a>
        <div class="text">
            <h4>Mobilier sur mesure 3 </h4>
            <p>Meilleur collection du mobilier   </p>
        </div>
    </div>
    <div id="overlay3" class="overlay">
        <a href="javascript:void(0)" class="closebtn" onclick="off()">&times;</a>
        <div class="text">
            <h4>Mobilier sur mesure 4 </h4>

            <p>classique et excellente</p>
    ...
    <div id="overlay4" class="overlay">
        <a href="javascript:void(0)" class="closebtn" onclick="off()">&times;</a>
        <div class="text">
            <h4>Mobilier sur mesure 5 </h4>
            <p>Mobilier modernes</p>
        </div>
    </div>
    <div id="overlay5" class="overlay">
        <a href="javascript:void(0)" class="closebtn" onclick="off()">&times;</a>
        <div class="text">
            <h4>Mobilier sur mesure 6 </h4>
            <p>Des meileurs mobiliers seulement sur SERVIGES</p>
        </div>
    </div>
    <div id="Acceuil">
        <section id="main">
